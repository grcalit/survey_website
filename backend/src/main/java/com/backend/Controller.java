...
public class Controller {
    ...
    public ResponseEntity<Topic1Entity> getTopic1(@PathVariable Long id) {
    ...
    public ResponseEntity<Topic1Entity> editTopic(@RequestBody Topic1Entity topic1) {
        Topic1Entity editedTopic = service1.editAnswer(topic1);
        if (editedTopic == null) {
            return ResponseEntity.status(400).body(topic1);
        }
    ...
    public ResponseEntity<Integer> deleteTopic1(@PathVariable Long id) {
